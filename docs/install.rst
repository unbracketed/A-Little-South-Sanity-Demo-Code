...
First, create a clean base environment using virtualenv::
    ...
    virtualenv South Sanity Demos
    cd South Sanity Demos
    source bin/activate
...
Install the requirements and the project source::
	...
	cd path/to/your/South Sanity Demos/repository
...
configuration files to get started quickly::
    ...
    cp South Sanity Demos/conf/local/example/* South Sanity Demos/conf/local
