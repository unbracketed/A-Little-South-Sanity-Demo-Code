...
env.hosts = ['South Sanity Demos.dev.lincolnloop.com']
env.root = '/opt/webapps/South Sanity Demos'
env.proj_root = env.root + '/src/South Sanity Demos'
...
def clone():
    ...
    with cd('%s/South Sanity Demos/conf/local' % env.proj_root):
